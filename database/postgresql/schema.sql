...
CREATE TABLE IF NOT EXISTS billing_rates (
    ...
    sewer_charge NUMERIC(10,2) NOT NULL DEFAULT 0.00,
    meter_charge NUMERIC(10,2) NOT NULL DEFAULT 0.00,
...
CREATE TABLE IF NOT EXISTS water_usage (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT uq_water_usage UNIQUE (customer_id, reading_month, reading_year),
...
CREATE TABLE IF NOT EXISTS bills (
    ...
    water_charge NUMERIC(12,2) NOT NULL DEFAULT 0.00,
    sewer_charge NUMERIC(12,2) NOT NULL DEFAULT 0.00,
    meter_charge NUMERIC(12,2) NOT NULL DEFAULT 0.00,
    arrears_brought_forward NUMERIC(12,2) NOT NULL DEFAULT 0.00,
    penalties NUMERIC(12,2) NOT NULL DEFAULT 0.00,
    total_amount NUMERIC(12,2) NOT NULL,
    amount_paid NUMERIC(12,2) NOT NULL DEFAULT 0.00,
    balance_due NUMERIC(12,2) NOT NULL,
    payment_status VARCHAR(20) NOT NULL DEFAULT 'UNPAID',
    generated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT uq_bills UNIQUE (customer_id, bill_month, bill_year),
